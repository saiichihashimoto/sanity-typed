...
describe("document", () => {
  describe("defineArrayMember", () => {
    it("builds parser for SanityDocument with fields", () => {
      ...
      const unparsed = [
        { ...fields, _type: "document", _key: "key", bar: true, tar: 1 },
      ];
    ...
    it("infers required fields", () => {
      ...
      const unparsed = [
        { ...fields, _type: "document", _key: "key", bar: true },
      ];
    ...
    it("infers nested objects", () => {
      ...
      const unparsed = [
        { ...fields, _type: "document", _key: "key", bar: { tar: 1 } },
      ];
  ...
  describe("defineField", () => {
    it("builds parser for SanityDocument with fields", () => {
      ...
      const unparsed = {
        _type: "foo",
        bar: { ...fields, _type: "document", bar: true, tar: 1 },
      };
    ...
    it("infers required fields", () => {
      ...
      const unparsed = {
        _type: "foo",
        bar: { ...fields, _type: "document", bar: true },
      };
    ...
    it("infers nested objects", () => {
      ...
      const unparsed = {
        _type: "foo",
        bar: { ...fields, _type: "document", bar: { tar: 1 } },
      };
